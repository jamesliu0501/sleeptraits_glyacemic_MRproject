# Overview
# This file contains the R script of the main analysis of one-sample Mendelian randomization (1SMRmain)
# Here we take sleep duration and insomnia vs HbA1c as an example (R codes of other sleep traits are similar)
...
# Exclusion 1 
## Exclude participants with self-reported diabetes or insulin use at the baseline
rm(list = ls())
...
data<-data[data$insulin!=1 & data$sr_diabetes!=1 ,] 
