...
# Genetic variant-sleep trait association was modeled using linear regression adjusting for sex, age, assessment centre, chip, 40 genetic principal components
